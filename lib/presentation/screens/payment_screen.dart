                                    ...
                                    child: Container(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          ...
                                          Text("${formatToTwoDecimalPlaces(dataWallet!.commistionFare.toString().replaceAll(",", ""))} ${dataWallet.currency == "KHR"?"៛":"\$"}",style: ThemeConstands.font22SemiBold.copyWith(color:AppColors.light4),textAlign: TextAlign.left,),
                                        ],
                                      ),
                                    ),
                                  ),
                                    ...
                                    child: Container(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          ...
                                          Text("${formatToTwoDecimalPlaces(dataWallet.balance.toString().replaceAll(",", ""))} ${dataWallet.currency == "KHR"?"៛":"\$"}",style: ThemeConstands.font22SemiBold.copyWith(color:AppColors.light4),textAlign: TextAlign.left,),
                                        ],
                                      ),
                                    ),
                                  ),
