                  ...
                  child: Column(
                    children: [
                      widget.routFrom == "FromDropBooking"
                          ? bodyRecive(
                              startTime: widget.dataComplete!.data!.startTime
                                  .toString(),
                              endAdd: widget.dataComplete!.data!.endAddress
                                  .toString(),
                              startAdd: widget.dataComplete!.data!.startAddress
                                  .toString(),
                              profile: widget
                              ...
                              passagerName: widget
                                  ...
                                  .toString(),
                              amount: widget.dataComplete!.data!.payment!.amount
                                  .toString(),
                              createAt: widget
                          ...
                          : bodyRecive(
                              startTime:
                                  widget.dataDriverInfo!.startTime.toString(),
                              endAdd:
                                  widget.dataDriverInfo!.endAddress.toString(),
                              startAdd: widget.dataDriverInfo!.startAddress
                                  .toString(),
                              profile: widget
                              ...
                              passagerName: widget
                                  ...
                                  .toString(),
                              amount: widget.dataDriverInfo!.payment!.amount
                                  .toString(),
                              createAt: widget
                                  .dataDriverInfo!.payment!.createdAt
                                  .toString(),
                              distance: widget.dataDriverInfo!.payment!.distance
                                  .toString(),
                              duration: widget.dataDriverInfo!.payment!.duration
                                  .toString(),
                            ),
                      const SizedBox(
                        height: 18,
