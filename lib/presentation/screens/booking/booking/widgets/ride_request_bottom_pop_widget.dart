                  ...
                  Row(
                    children: [
                      ClipRRect(
                        ...
                        child: TImageWidget(
                          image:
                              NetworkImage(widget.profilePassanger.toString()),
                          width: 50,
                        ),
                      ),
                      Expanded(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        child: Text(
                                      widget.processType == 1
                                          ? "${"PASSENGER_LOCATION".tr()}: (${widget.passegerLocationName.toString()})"
                                          : "${widget.processType == 3 || widget.processType == 4 ? "START_LOCATION".tr() : "DRIVER_LOCATION".tr()}: (${widget.currentLocationName.toString()})",
                                      style: ThemeConstands.font16Regular
                                          .copyWith(color: AppColors.dark1),
                                    )),
                                  ],
                                ),
                                widget.whereToGoLocationName == "" &&
                                        (widget.processType == 1 ||
                                            widget.processType == 3 ||
                                    ...
                                    : Row(
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            ...
                                            widget.processType == 2
                                                ? "${"PASSENGER_LOCATION".tr()}: (${widget.passegerLocationName.toString()})"
                                                : "${widget.processType == 3 || (widget.processType == 4 && widget.whereToGoLocationName != "") || (widget.processType == 1 && widget.whereToGoLocationName != "") ? "WHERE_TO_GO".tr() : "PASSENGER_LOCATION".tr()}: (${widget.whereToGoLocationName.toString()})",
                                            style: ThemeConstands.font16Regular
                                                .copyWith(
                                                    color: AppColors.dark1),
                                          )),
                      ...
                      child: FBTNWidget(
                        ...
                        widget.processType == 1
                                  ...
                                  : widget.processType == 2
                                      ...
                                      : widget.processType == 3
                                          ? "START_RIDE".tr()
                                          : widget.processType == 4 || widget.processType == 6
                                                  ? "DROP".tr()
                                      : "",
                        enableWidth: true,
                        // enableWidth: false,
