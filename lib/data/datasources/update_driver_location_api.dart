...
import 'package:tara_driver_application/data/models/driver_location_model.dart';
import 'package:dio/dio.dart';
import 'package:logger/logger.dart';

class UpdateDriverLocation {
  Future<UpdateDriverLocationModel> updateDriverLocationApi(
      {double? lat, double? log, required double? heading}) async {
    ...
    return BaseApiService().onRequest<UpdateDriverLocationModel>(
      ...
      onSuccess: (result) {
        Logger().i("Update location again $result");
